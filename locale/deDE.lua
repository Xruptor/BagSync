...
L.EnableAddonCompartment = "Blizzard Addon Compartment-Integration aktivieren."
L.ResetMinimapBtn = "Minikarten-Button-Position zurücksetzen."
L.AddonCompartmentReloadMsg = "Änderungen am Addon-Compartment erfordern einen UI-Neustart. Verwende /reload zum Anwenden."
...
L.ConfigCache = "Cache"
L.ConfigCacheHeader = "Einstellungen und Drosselung des Item-Caches für BagSync."
L.ConfigCacheHowTitle = "Wie Der Cache Funktioniert"
L.ConfigCacheHowText_1 = "Item-Infos sind beim Einloggen nicht vollständig verfügbar. APIs wie |cFFB19CD9GetItemInfo|r oder |cFFB19CD9C_Item.GetItemInfo|r liefern nil (oder nichts), bis das Item für deine Sitzung gecacht ist."
L.ConfigCacheHowText_2 = "BagSync fordert fehlende Itemdaten in kleinen Stapeln an und wartet, bis der Client sie erhält (derselbe Ablauf, der GET_ITEM_INFO_RECEIVED auslöst)."
L.ConfigCacheHowText_3 = "Drosselung hält die Performance stabil, während der Cache sich füllt, damit Suchen und Tooltips nach und nach vollständig werden."
L.ConfigCacheRatesTitle = "Aktuelle Raten"
L.ConfigCacheSpeedTitle = "Cache-Geschwindigkeit"
L.ConfigCacheSpeedLabel = "Drosselung"
L.ConfigCacheSpeedHelp = "|cFFB19CD9Langsam|r ist Standard und am besten für die Performance, aber Suchen brauchen länger, bis alles gecacht ist.\n|cFFB19CD9Mittel|r ist schneller, kann aber kleine Login-Spitzen verursachen.\n|cFFB19CD9Schnell|r ist am intensivsten und kann beim Login Lag-Spitzen verursachen.\n|cFFFF4D4DDeaktiviert|r ist |cFFFF4D4Dnicht empfohlen|r (|cFFFFFFFFBagSync nutzt |cFFB19CD9Schnell|r, während das Suchfenster offen ist und während der Suche.|r)"
L.CacheSpeedSlow = "Langsam (Hintergrund + Ramp)"
L.CacheSpeedMedium = "Mittel"
L.CacheSpeedFast = "Schnell"
L.CacheSpeedDisabled = "Deaktiviert (Kein Hintergrund-Cache)"
L.CacheSpeedRampIntro = "Langsam-Modus erhöht alle %d Sekunden."
L.CacheSpeedRampLine = "Stufe %d: %d Items alle %.2fs (~%d pro Sekunde)."
L.CacheSpeedSingleLine = "%d Items alle %.2fs (~%d pro Sekunde)."
L.CacheSpeedDisabledSummary = "Hintergrund-Cache ist deaktiviert. Beim Öffnen nutzt BagSync Schnell, und Suchen laufen ebenfalls mit Schnell."
...
L.ConfigExtTipPositionSettings = "Positionseinstellungen für externen Tooltip"
L.ConfigExtTipCustomAnchorEnable = "Benutzerdefinierte Ankerposition aktivieren"
L.ConfigExtTipCustomAnchorLocation = "Benutzerdefinierter Ort"
L.ConfigExtTipCustomAnchorShow = "ExtTip-Anker anzeigen"
L.ExtTipCustomAnchor_TopLeft = "Oben links"
L.ExtTipCustomAnchor_TopRight = "Oben rechts"
L.ExtTipCustomAnchor_BottomLeft = "Unten links"
L.ExtTipCustomAnchor_BottomRight = "Unten rechts"
L.ExtTipCustomAnchor_Center = "Zentriert"
L.ExtTipCustomAnchor_CenterTop = "Zentriert oben"
L.ExtTipCustomAnchor_CenterBottom = "Zentriert unten"
L.ExtTipCustomAnchor_UseAnchor = "ExtTip-Anker verwenden"
L.ExtTipAnchorLabel = "BagSync-ExtTip-Anker\n\n(Rechtsklick zum Speichern der Position)"
...
L.ExtTipNoticeTitle = "Hinweis zum externen Tooltip (ExtTip)"
L.ExtTipNoticeText = "|cFFFFFFFFBlizzards |cFFFF0000Secret Values|r|cFFFFFFFF können die ExtTip-Positionierung blockieren. BagSync nutzt Schutzmaßnahmen, aber wenn kein sicherer Tooltip gefunden wird, erscheinen die Zählungen im |cFFFF0000GameTooltip|r|cFFFFFFFF. Siehe die FAQ zu |cFFFF0000'Secret Values'|r|cFFFFFFFF für Details.|r"
...
L.CachingItemData = "Zwischenspeichern von Itemdaten... (%d verbleibend)"
...
L.FAQ_Question_8 = "Fehler durch Secret Values & Blizzard-Addon-Beschränkungen"
L.FAQ_Question_8_p1 = [[
Blizzards neues |cFFDF2B2B"Secret Values"|r-System ist so konzipiert, dass Addons bestimmte kampfbezogene Daten |cFF99CC33anzeigen|r können, aber |cFFDF2B2Bnicht sicher inspizieren oder darauf Berechnungen durchführen können|r. In tainted Code-Pfaden führen Rechenoperationen, Vergleiche und sogar bestimmte Indizierungen dieser Werte sofort zu Lua-Fehlern. Diese Werte können Frames und Tooltips über geheime Aspekte/Anker auch "infizieren", sodass |cFF99CC33derselbe Tooltip|r später geheime Koordinaten zurückliefert – selbst wenn das Addon, das ihn berührt, den Secret Value gar nicht zuerst erzeugt hat. Das bedeutet, dass ein Stacktrace, der auf BagSync zeigt, |cFFDF2B2Bnicht|r beweist, dass BagSync den Secret Value eingebracht hat; häufig heißt es nur, dass BagSync das bereits kontaminierte Objekt als Nächstes angefasst hat.

Das ist kein reines BagSync-Problem. Blizzards eigene UI wirft dieselben "attempt to perform arithmetic on a secret value"-Fehler (z. B. MoneyFrame / GameTooltip) sogar ohne Drittanbieter-Addons. Andere Addons liefern bereits Notfall-Fixes oder Schutzprüfungen für die |cFF99CC33genau dieselbe Fehlerklasse|r, die durch Secret Values in Tooltips und Money Frames ausgelöst wird. |cFFDF2B2BKurz gesagt: Das ist ein breites Plattformproblem, kein spezieller BagSync-Bug|r.

Ich |cFFDF2B2Bhabe versucht|r, so viele Schutzmaßnahmen und defensive Prüfungen wie möglich einzubauen, um die Wahrscheinlichkeit zu verringern, dass BagSync diese Fehler auslöst, aber Blizzard hat Secret Values in einer gemischten Addon-Umgebung |cFFDF2B2Bextrem schwer nachzuverfolgen und zu kontrollieren|r gemacht – mit Absicht. Dieses System verhindert aktiv, dass Addons den Wert zuverlässig inspizieren oder überhaupt bestätigen können, |cFF99CC33wo|r er entstanden ist. Genau deshalb sind diese Fehler schwer zu reproduzieren und tauchen oft erst auf, wenn der Fehler ausgelöst wird.
]]
