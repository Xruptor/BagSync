...
L.ExtTipNoticeText = "|cFFFFFFFFLos |cFFFF0000Secret Values|r|cFFFFFFFF de Blizzard pueden bloquear la posición de ExtTip. BagSync añade protecciones, pero si no se encuentra un tooltip seguro, los recuentos se muestran en el |cFFFF0000GameTooltip|r|cFFFFFFFF. Consulta la FAQ sobre |cFFFF0000'Secret Values'|r|cFFFFFFFF.|r"
