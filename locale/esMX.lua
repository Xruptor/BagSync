...
L.Search = "Buscar"
L.Debug = "Depuración"
L.AdvSearchBtn = "Buscar/Actualizar"
L.Reset = "Restablecer"
...
L.ClickViewProfession = "Haga clic para ver la profesión:"
L.ClickHere = "Haga clic aquí"
...
L.ProfilesErrorRemove = "Eliminar el error de BagSync."
L.ProfileBeenRemoved = "[%s][|cFF99CC33%s|r] perfil eliminado de BagSync!"
L.ProfessionsFailedRequest = "Solicitud de servidor fallada."
...
L.ScanGuildBankStart = "Consultando el servidor para la información del banco de hermandad, por favor espere...."
...
L.ScanGuildBankScanInfo = "Escaneando pestaña de hermandad (%s/%s)."
...
L.DisplayMailbox = "Mostrar elementos de buzón."
L.DisplayAuctionHouse = "Mostrar artículos de casa de subasta."
...
L.DisplaySourceDebugInfo = "Mostrar información útil [Debug] en el campo de herramientas."
...
L.DisplayGuildSeparately = "Mostrar nombres y totales de objetos de la [Hermandad] por separado de los totales de personajes."
L.DisplayGuildCurrentCharacter = "Mostrar los objetos de la [Hermandad] solo para personajes conectados actualmente."
L.DisplayGuildBankScanAlert = "Mostrar la ventana de alerta de escaneo del banco de hermandad."
...
L.ConfigHeader = "Ajustes para varias características de BagSync."
...
L.ConfigSearchHeader = "Ajustes para la ventana de búsqueda"
L.ConfigFont = "Fuente"
...
L.WarningUpdatedDB = "Usted ha sido actualizado a la última versión de la base de datos! ¡Tendrás que cambiar de nuevo a todos tus personajes! |r"
