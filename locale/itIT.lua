...
L.EnableAddonCompartment = "Abilita l'integrazione con il Compartimento degli addon di Blizzard."
L.ResetMinimapBtn = "Reimposta la posizione del pulsante della minimappa."
L.AddonCompartmentReloadMsg = "Le modifiche al Compartimento degli addon richiedono un ricaricamento dell'interfaccia. Usa /reload per applicare."
...
L.ConfigCache = "Cache"
L.ConfigCacheHeader = "Impostazioni della cache oggetti e limitazione per BagSync."
L.ConfigCacheHowTitle = "Come Funziona La Cache"
L.ConfigCacheHowText_1 = "Le informazioni sugli oggetti non sono completamente disponibili al login. API come |cFFB19CD9GetItemInfo|r o |cFFB19CD9C_Item.GetItemInfo|r restituiscono nil (o nulla) finché l’oggetto non viene messo in cache per la sessione."
L.ConfigCacheHowText_2 = "BagSync richiede i dati mancanti in piccoli lotti e attende che il client li riceva (lo stesso flusso che attiva GET_ITEM_INFO_RECEIVED)."
L.ConfigCacheHowText_3 = "La limitazione mantiene le prestazioni stabili mentre la cache si riempie, così ricerche e tooltip si completano nel tempo."
L.ConfigCacheRatesTitle = "Velocità Correnti"
L.ConfigCacheSpeedTitle = "Velocità Cache"
L.ConfigCacheSpeedLabel = "Limitazione"
L.ConfigCacheSpeedHelp = "|cFFB19CD9Lento|r è il predefinito ed è il migliore per le prestazioni, ma le ricerche impiegano più tempo per cacheare tutto.\n|cFFB19CD9Medio|r è più veloce, ma può causare piccoli picchi al login.\n|cFFB19CD9Veloce|r è il più intenso e può causare picchi di lag al login.\n|cFFFF4D4DDisattivato|r |cFFFF4D4Dnon è consigliato|r (|cFFFFFFFFBagSync userà |cFFB19CD9Veloce|r mentre la finestra di ricerca è aperta e durante le ricerche.|r)"
L.CacheSpeedSlow = "Lento (Sfondo + Rampa)"
L.CacheSpeedMedium = "Medio"
L.CacheSpeedFast = "Veloce"
L.CacheSpeedDisabled = "Disattivato (Nessuna cache in background)"
L.CacheSpeedRampIntro = "La modalità Lento aumenta ogni %d secondi."
L.CacheSpeedRampLine = "Passo %d: %d oggetti ogni %.2fs (~%d al secondo)."
L.CacheSpeedSingleLine = "%d oggetti ogni %.2fs (~%d al secondo)."
L.CacheSpeedDisabledSummary = "La cache in background è disattivata. All’apertura BagSync usa Veloce e le ricerche usano Veloce."
...
L.ConfigFont = "Fonti"
L.ConfigExtTooltipAnchor = "Posizione del GameTooltip"
L.ConfigExtTipPositionSettings = "Impostazioni posizione del tooltip esterno"
L.ConfigExtTipCustomAnchorEnable = "Abilita posizione ancoraggio personalizzata"
L.ConfigExtTipCustomAnchorLocation = "Posizione personalizzata"
L.ConfigExtTipCustomAnchorShow = "Mostra ancoraggio ExtTip"
L.ExtTipCustomAnchor_TopLeft = "Alto sinistra"
L.ExtTipCustomAnchor_TopRight = "Alto destra"
L.ExtTipCustomAnchor_BottomLeft = "Basso sinistra"
L.ExtTipCustomAnchor_BottomRight = "Basso destra"
L.ExtTipCustomAnchor_Center = "Centro"
L.ExtTipCustomAnchor_CenterTop = "Centro alto"
L.ExtTipCustomAnchor_CenterBottom = "Centro basso"
L.ExtTipCustomAnchor_UseAnchor = "Usa ancoraggio ExtTip"
L.ExtTipAnchorLabel = "Ancoraggio ExtTip di BagSync\n\n(Clic destro per salvare la posizione)"
...
L.ExtTooltipAnchor_Bottom = "Basso"
L.ExtTooltipAnchor_Left = "Sinistra"
L.ExtTooltipAnchor_Right = "Destra"
L.ExtTipNoticeTitle = "Avviso tooltip esterno (ExtTip)"
L.ExtTipNoticeText = "|cFFFFFFFFI |cFFFF0000Secret Values|r|cFFFFFFFF di Blizzard possono bloccare il posizionamento di ExtTip. BagSync aggiunge protezioni, ma se non viene trovato un tooltip sicuro, i conteggi tornano nel |cFFFF0000GameTooltip|r|cFFFFFFFF. Vedi la FAQ su |cFFFF0000'Secret Values'|r|cFFFFFFFF per i dettagli.|r"
...
L.CachingItemData = "Memorizzazione dati oggetti... (%d rimanenti)"
...
L.FAQ_Question_8 = "Errori dei secret values e restrizioni degli addon Blizzard"
L.FAQ_Question_8_p1 = [[
Il nuovo sistema di |cFFDF2B2B"secret values"|r di Blizzard è progettato affinché gli addon possano |cFF99CC33mostrare|r alcuni dati legati al combattimento ma |cFFDF2B2Bnon possano ispezionarli o calcolarci sopra in modo sicuro|r. Nei percorsi di codice contaminati, operazioni aritmetiche, confronti e persino alcune indicizzazioni su questi valori generano errori Lua immediati. Questi valori possono anche "infettare" frame e tooltip tramite aspetti/ancoraggi segreti, così |cFF99CC33lo stesso tooltip|r può iniziare a restituire coordinate segrete più tardi, anche se l'addon che lo ha toccato non ha creato il valore segreto in origine. Ciò significa che uno stack trace che punta a BagSync |cFFDF2B2Bnon|r prova che BagSync abbia introdotto il valore segreto; spesso significa solo che BagSync è stato l'addon successivo a toccare l'oggetto già contaminato.

Questo non è un problema esclusivo di BagSync. Anche l'interfaccia di Blizzard genera gli stessi errori "attempt to perform arithmetic on a secret value" (ad es. MoneyFrame / GameTooltip) anche senza addon di terze parti. Altri addon stanno già distribuendo correzioni di emergenza o protezioni per la |cFF99CC33stessa identica classe di errore|r causata dai secret values nei tooltip e nei money frame. |cFFDF2B2BIn breve: è un problema di piattaforma, non un bug unico di BagSync|r.

Ho |cFFDF2B2Bprovato|r ad aggiungere quante più salvaguardie e controlli difensivi possibile per ridurre le probabilità che BagSync scateni questi errori, ma Blizzard ha reso i secret values |cFFDF2B2Bestremamente difficili da tracciare e controllare|r in un ambiente con addon misti, per design. Questo sistema impedisce attivamente agli addon di ispezionare il valore in modo affidabile o anche solo di confermare |cFF99CC33dove|r sia nato. È esattamente per questo che questi errori sono difficili da riprodurre e spesso compaiono solo quando l'errore si manifesta.
]]
L.BagSyncInfoWindow = [[
