...
L.Search = "Ricerca"
L.Debug = "Debug"
L.AdvSearchBtn = "Ricerca/Rifresco"
L.Reset = "Ripristino"
L.Refresh = "Aggiorna"
L.Clear = "Libero"
L.AdvancedSearch = "Ricerca avanzata"
L.AdvancedSearchInformation = "* Utilizza BagSync |cffff7d0a[CR]|r e |cff3587ff[BNet]|r impostazioni."
L.AdvancedLocationInformation = "* Selezionando nessuna impostazione predefinita per selezionare TUTTE."
L.Units = "Unità:"
...
L.ClickViewProfession = "Clicca per vedere la professione:"
L.ClickHere = "Clicca qui"
...
L.ProfilesErrorRemove = "Cancellazione di errore da BagSync."
L.ProfileBeenRemoved = "[%s][|cFF99CC33%s|r] profilo cancellato da BagSync!"
L.ProfessionsFailedRequest = "[%s] Richiesta server non riuscita."
...
L.ScanGuildBankStart = "Interrogazione del server per le informazioni della banca di gilda, attendere...."
...
L.ScanGuildBankScanInfo = "Scansione scheda gilda (%s/%s)."
...
L.AlwaysShowAdvSearch = "Mostra sempre la finestra di ricerca avanzata Bagsync."
...
L.DisplayMailbox = "Visualizza articoli della casella di posta."
L.DisplayAuctionHouse = "Visualizza articoli della casa d'asta."
...
L.DisplaySourceDebugInfo = "Visualizzare informazioni utili [Debug] in tooltip."
...
L.DisplayGuildSeparately = "Visualizzazione [Guild] nomi e voce totali separatamente da totali di carattere."
L.DisplayGuildCurrentCharacter = "Visualizza gli elementi [Guild] solo per il carattere attualmente registrato."
L.DisplayGuildBankScanAlert = "Visualizza la finestra di avviso della banca di gilda."
...
L.ConfigHeader = "Impostazioni per varie funzioni BagSync."
...
L.ConfigSearchHeader = "Impostazioni per la finestra di ricerca"
L.ConfigFont = "Fonti"
...
L.WarningUpdatedDB = "Sei stato aggiornato alla versione più recente del database! Dovrai riscantare tutti i tuoi personaggi! |r"
