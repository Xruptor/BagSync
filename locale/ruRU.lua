...
L.ON = "ВКЛ"
L.OFF = "ВЫКЛ"
L.LeftClickSearch = "|cffddff00ЛКМ|r |cff00ff00= Окно поиска|r"
L.RightClickBagSyncMenu = "|cffddff00ПКМ|r |cff00ff00= Меню BagSync|r"
L.ProfessionInformation = "|cffddff00ЛКМ|r |cff00ff00на профессии для просмотра рецептов.|r"
...
L.ProfessionHasRecipes = "ЛКМ для просмотра рецептов."
...
L.EnableAddonCompartment = "Включить интеграцию с отсеком аддонов Blizzard."
L.ResetMinimapBtn = "Сбросить позицию кнопки миникарты."
L.AddonCompartmentReloadMsg = "Изменения отсека аддонов требуют перезагрузки интерфейса. Используйте /reload."
...
L.DisplayBankTabs = "Отображать вкладки банка [1,2,3, и т.д.] во всплывающей подсказке."
...
L.SortMode = "Режим сортировки"
L.SortMode_RealmCharacter = "Сервер, затем персонаж (по умолчанию)"
L.SortMode_Character = "Персонаж"
L.SortMode_ClassCharacter = "Класс, затем персонаж"
...
L.ColorBankTabs = "Цвет вкладок банка [1,2,3, и т.д.] всплывающей подсказки."
...
L.ConfigCache = "Кэш"
L.ConfigCacheHeader = "Настройки кэша предметов и ограничений BagSync."
L.ConfigCacheHowTitle = "Как Работает Кэш"
L.ConfigCacheHowText_1 = "Информация о предметах недоступна полностью при входе. API вроде |cFFB19CD9GetItemInfo|r или |cFFB19CD9C_Item.GetItemInfo|r возвращают nil (или ничего), пока предмет не закэширован для сессии."
L.ConfigCacheHowText_2 = "BagSync запрашивает недостающие данные небольшими пакетами и ждёт, пока клиент их получит (тот же поток, который вызывает GET_ITEM_INFO_RECEIVED)."
L.ConfigCacheHowText_3 = "Ограничение сохраняет производительность стабильной, пока кэш заполняется, чтобы поиски и подсказки постепенно становились полными."
L.ConfigCacheRatesTitle = "Текущие Скорости"
L.ConfigCacheSpeedTitle = "Скорость Кэша"
L.ConfigCacheSpeedLabel = "Ограничение"
L.ConfigCacheSpeedHelp = "|cFFB19CD9Медленно|r — режим по умолчанию и лучший для производительности, но поиски кэшируются дольше.\n|cFFB19CD9Средне|r быстрее, но может вызвать небольшие пики при входе.\n|cFFB19CD9Быстро|r самый интенсивный и может вызвать лаги при входе.\n|cFFFF4D4DОтключено|r |cFFFF4D4Dне рекомендуется|r (|cFFFFFFFFBagSync будет использовать |cFFB19CD9Быстро|r, пока окно поиска открыто и во время поиска.|r)"
L.CacheSpeedSlow = "Медленно (Фон + Нарастание)"
L.CacheSpeedMedium = "Средне"
L.CacheSpeedFast = "Быстро"
L.CacheSpeedDisabled = "Отключено (Нет фонового кэша)"
L.CacheSpeedRampIntro = "Режим Медленно повышается каждые %d секунд."
L.CacheSpeedRampLine = "Шаг %d: %d предметов каждые %.2fs (~%d в сек.)."
L.CacheSpeedSingleLine = "%d предметов каждые %.2fs (~%d в сек.)."
L.CacheSpeedDisabledSummary = "Фоновый кэш отключён. При открытии BagSync используется Быстро, и поиски также идут в режиме Быстро."
...
L.ConfigFont = "Шрифт"
L.ConfigExtTooltipAnchor = "Позиция GameTooltip"
L.ConfigExtTipPositionSettings = "Настройки позиции внешнего tooltip"
L.ConfigExtTipCustomAnchorEnable = "Включить пользовательскую позицию якоря"
L.ConfigExtTipCustomAnchorLocation = "Пользовательское расположение"
L.ConfigExtTipCustomAnchorShow = "Показать якорь ExtTip"
L.ExtTipCustomAnchor_TopLeft = "Вверху слева"
L.ExtTipCustomAnchor_TopRight = "Вверху справа"
L.ExtTipCustomAnchor_BottomLeft = "Внизу слева"
L.ExtTipCustomAnchor_BottomRight = "Внизу справа"
L.ExtTipCustomAnchor_Center = "По центру"
L.ExtTipCustomAnchor_CenterTop = "Сверху по центру"
L.ExtTipCustomAnchor_CenterBottom = "Снизу по центру"
L.ExtTipCustomAnchor_UseAnchor = "Использовать якорь ExtTip"
L.ExtTipAnchorLabel = "Якорь ExtTip BagSync\n\n(ПКМ чтобы сохранить позицию)"
...
L.ExtTooltipAnchor_Bottom = "Снизу"
L.ExtTooltipAnchor_Left = "Слева"
L.ExtTooltipAnchor_Right = "Справа"
L.ExtTipNoticeTitle = "Уведомление о внешнем tooltip (ExtTip)"
L.ExtTipNoticeText = "|cFFFFFFFF|cFFFF0000Secret Values|r|cFFFFFFFF от Blizzard могут мешать позиционированию ExtTip. BagSync добавляет защиту, но если безопасный tooltip не найден, счетчики выводятся в |cFFFF0000GameTooltip|r|cFFFFFFFF. См. FAQ про |cFFFF0000'Secret Values'|r|cFFFFFFFF.|r"
...
L.CachingItemData = "Кеширование данных предметов... (осталось %d)"
...
L.FAQ_Question_8 = "Ошибки secret values и ограничения аддонов Blizzard"
L.FAQ_Question_8_p1 = [[
Новая система |cFFDF2B2B«secret values»|r от Blizzard устроена так, чтобы аддоны могли |cFF99CC33отображать|r некоторые боевые данные, но |cFFDF2B2Bне могли безопасно их инспектировать или выполнять вычисления над ними|r. В заражённых путях кода арифметика, сравнения и даже некоторые обращения по индексу к этим значениям сразу вызывают ошибки Lua. Эти значения также могут «заражать» фреймы и подсказки через секретные аспекты/якоря, так что |cFF99CC33тот же самый тултип|r позже может начать возвращать секретные координаты — даже если аддон, который его тронул, изначально не создавал secret value. Это означает, что стек-трейс, указывающий на BagSync, |cFFDF2B2Bне|r доказывает, что BagSync ввёл secret value; чаще всего это лишь значит, что BagSync был следующим аддоном, который коснулся уже заражённого объекта.

Это не проблема только BagSync. Собственный интерфейс Blizzard выдаёт те же ошибки «attempt to perform arithmetic on a secret value» (например, MoneyFrame / GameTooltip) даже без сторонних аддонов. Другие аддоны уже выпускают экстренные исправления или защитные проверки для |cFF99CC33той же самой категории ошибок|r, вызываемых secret values в тултипах и money frame. |cFFDF2B2BКороче: это широкая проблема платформы, а не уникальный баг BagSync|r.

Я |cFFDF2B2Bпытался|r добавить как можно больше защит и оборонительных проверок, чтобы снизить вероятность того, что BagSync будет вызывать эти ошибки, но Blizzard сделала secret values |cFFDF2B2Bкрайне трудными для отслеживания и контроля|r в среде с множеством аддонов — намеренно. Эта система активно мешает аддонам надёжно инспектировать значение или даже подтвердить, |cFF99CC33где|r оно возникло. Именно поэтому такие ошибки трудно воспроизвести, и они часто появляются только в момент срабатывания.
]]
L.BagSyncInfoWindow = [[
