...
L.DisplayCurrentCharacter = "当前玩家" 
L.DisplayCurrentCharacterOnly = "|cFFFFD700仅限！|r鼠标提示上显示\"当前\"玩家的BagSync数据。|cFFDF2B2B（不推荐）|r"
L.DisplayBlacklistCurrentCharOnly = "|cFFFFD700仅限！|r显示\"当前\"玩家的黑名单物品数量。|cFFDF2B2B（不推荐）|r"
