...
L.DisplayCrossRealm = "显示|cFF99CC33[同服务器]|r信息 |cffff7d0a[XR]|r"
...
|cffff7d0a等级搜索|r:
示例: |cFF99CC33!|r|cFFFFD580bind:boe|r (not boe)
示例: |cFF99CC33!|r|cFFFFD580bind:boe|r |cFF99CC33&|r |cFFFFD580lvl:>20|r (专业装备和配饰的物品等级大于20)
|cffff7d0a公会搜索 (和搜索):|r
