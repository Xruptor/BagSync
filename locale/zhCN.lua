...
L.EnableExtTooltip = "在其他鼠标提示上显示物品统计数据"
L.EnableLoginVersionInfo = "显示BagSync的登录信息"
L.DisplayTotal = "显示 [总计] 金额"
L.DisplayGuildGoldInGoldTooltip = "显示 [公会] 金币总数在鼠标提示"
L.DisplayGuildBank = "显示公会银行物品|cFF99CC33(启用公会银行扫描)|r"
...
L.DisplayShowUniqueItemsTotalsTitle = "显示唯一物品的总数在鼠标提示上"
L.DisplayShowUniqueItemsEnableText = "启用唯一物品的总数"
L.ColorPrimary = "主要 BagSync 鼠标提示颜色"
L.ColorSecondary = "辅助 BagSync 鼠标提示颜色"
L.ColorTotal = "BagSync [总计] 鼠标提示颜色"
L.ColorGuild = "BagSync [公会] 鼠标提示颜色"
L.ColorCrossRealm = "BagSync [服务器] 鼠标提示颜色"
L.ColorBNET = "BagSync [战网] 鼠标提示颜色"
L.ColorItemID = "BagSync [物品ID] 鼠标提示颜色"
L.ConfigHeader = "各种 BagSync 功能的设置"
L.ConfigDisplay = "显示"
L.ConfigTooltipHeader = "显示的 BagSync 鼠标提示信息的设置"
L.ConfigColor = "颜色"
L.ConfigColorHeader = "BagSync 鼠标提示信息的颜色设置"
L.ConfigMain = "主要"
