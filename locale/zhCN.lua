...
L.FixDB = "修复数据库"
L.Config = "配置"
L.DeleteWarning = "选择要删除的配置。注意：此操作不可逆！"
L.Delete = "删除"
L.SelectAll = "全选"
...
L.AddonCompartmentReloadMsg = "插件收纳盒更改需要重载界面。请使用 /reload 重载更改。"
...
L.DisplaySingleCharLocs = "为储存位置显示单字符缩写。"
L.DisplayIconLocs = "为储存位置显示图标。"
L.DisplayStorageLocStyle = "储存位置标签样式。"
L.DisplayStorageLocStyle_Full = "显示完整的储存位置文本。"
