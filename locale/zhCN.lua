...
L.ShowOnModifierDesc = "显示在 BagSync 鼠标提示上快捷键设置。"
...
L.DisplayCR = "显示 |cffff7d0a[互通服务器]|r 。|cffff7d0a[CR]|r"
L.DisplayBNET = "显示所有战网账号信息 |cff3587ff[BNet]|r |cFFDF2B2B(不推荐)|r"
L.DisplayItemID = "显示 [物品ID] 。"
L.DisplaySourceDebugInfo = "在鼠标提示中显示有用的 [Debug] 信息。"
L.DisplayWhiteListOnly = "在鼠标提示中仅显示 [白名单]的物品。"
L.DisplaySourceExpansion = "在鼠标提示中显示 [物品来源] 。 |cFF99CC33[仅正式服]|r"
...
L.DisplayAccountWideTagOpts = "|cFF99CC33选项 ( |cffff7d0a[CR]|r & |cff3587ff[BNet]|r )|r"
L.DisplayGreenCheck = "在当前角色名前显示 %s 。"
L.DisplayRealmIDTags = "显示 |cffff7d0a[CR]|r 和 |cff3587ff[BNet]|r 标识符号。"
L.DisplayRealmNames = "显示服务器名字。"
L.DisplayRealmAstrick = "显示 [*] 而不是显示 |cffff7d0a[CR]|r 和 |cff3587ff[BNet]|r。"
L.DisplayShortRealmName = "显示短位名字 |cffff7d0a[CR]|r 和 |cff3587ff[BNet]|r。"
L.DisplayFactionIcons = "显示阵营图标。"
L.DisplayGuildBankTabs = "在鼠标提示中显示银行标签 [1,2,3, 等...]。"
...
L.ColorCR = "BagSync [互通服务器] 提示颜色。"
L.ColorBNET = "BagSync [战网] 提示颜色。"
L.ColorItemID = "BagSync [物品ID] 提示颜色。"
L.ColorExpansion = "BagSync [物品来源] 提示颜色。"
