...
L.ExtTipNoticeText = "|cFFFFFFFF暴雪的 |cFFFF0000Secret Values|r|cFFFFFFFF 可能会影响 ExtTip 的定位。BagSync 已加入防护，但若找不到安全的提示，将在 |cFFFF0000GameTooltip|r|cFFFFFFFF 中显示计数。更多信息请查看 FAQ 中的 |cFFFF0000'Secret Values'|r|cFFFFFFFF。|r"
L.ConfigTracking = "追踪"
