...
L.DisplayCurrentPlayerOnly = "Display BagSync tooltip data for the current player |cFFFFD700ONLY!|r"
L.DisplayCurrentPlayerWarn = "|cFF99CC33[Disables Guilds]|r |cFFDF2B2B(Not Recommended)|r"
