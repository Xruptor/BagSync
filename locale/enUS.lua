local _, BSYC = ...
local L = BSYC:NewLocale("enUS", true)
...
L.Reset = "Reset"
L.Clear = "Clear"
L.SearchFilters = "Search Filters"
L.SearchFiltersInformation = "* Uses BagSync |cffff7d0a[CR]|r and |cff3587ff[BNet]|r settings."
L.SearchFiltersLocationInformation = "* Selecting none defaults to selecting ALL."
L.Units = "Units:"
...
L.AlwaysShowSearchFilters = "Always show the Bagsync Search Filters window."
...
L.EnableAddonCompartment = "Enable Blizzard Addon Compartment integration."
L.ResetMinimapBtn = "Reset minimap button position."
L.AddonCompartmentReloadMsg = "Addon Compartment changes require a UI reload. Use /reload to apply."
...
L.DisplayStorageLocStyle = "Storage location tags."
L.DisplayStorageLocStyle_Full = "Display full storage location text."
L.DisplayRealmNameStyle = "Realm name style."
L.None = "None"
...
L.SortMode = "Sort mode"
L.SortMode_RealmCharacter = "Realm then Character (default)"
L.SortMode_Character = "Character"
L.SortMode_ClassCharacter = "Class then Character"
...
L.ConfigCache = "Cache"
L.ConfigCacheHeader = "Item cache settings and throttling options for BagSync."
L.ConfigCacheHowTitle = "How The Cache Works"
L.ConfigCacheHowText_1 = "Item info is not fully available when you log in. APIs like |cFFB19CD9GetItemInfo|r or |cFFB19CD9C_Item.GetItemInfo|r return nil (or nothing) until that item is cached for your session."
L.ConfigCacheHowText_2 = "BagSync requests missing item data in small batches and waits for the client to receive it from the server."
L.ConfigCacheHowText_3 = "Throttling keeps performance smooth while the cache warms up so searches and tooltips can fill in over time."
L.ConfigCacheRatesTitle = "Current Rates"
L.ConfigCacheSpeedTitle = "Cache Speed"
L.ConfigCacheSpeedLabel = "Throttle"
L.ConfigCacheSpeedHelp = "|cFFB19CD9Slow|r is the default and best for performance, but searches take longer to fully cache.\n|cFFB19CD9Medium|r is faster but may cause small login spikes.\n|cFFB19CD9Fast|r is the most intense and can cause lag spikes on login.\n|cFFFF4D4DDisabled|r is |cFFFF4D4Dnot recommended|r (|cFFFFFFFFBagSync will use |cFFB19CD9Fast|r throttle while the search window is open and during searches while disabled.|r)"
L.CacheSpeedSlow = "Slow (Background + Ramp)"
L.CacheSpeedMedium = "Medium"
L.CacheSpeedFast = "Fast"
L.CacheSpeedDisabled = "Disabled (No Background Cache)"
L.CacheSpeedRampIntro = "Slow mode ramps every %d seconds."
L.CacheSpeedRampLine = "Step %d: %d items every %.2fs (~%d per second)."
L.CacheSpeedSingleLine = "%d items every %.2fs (~%d per second)."
L.CacheSpeedDisabledSummary = "Background cache is disabled. Opening BagSync uses Fast throttle, and searches also run at Fast throttle."
L.ConfigMain = "Main"
...
L.ConfigFont = "Font"
L.ConfigExtTooltipAnchor = "GameTooltip Position"
L.ConfigExtTipPositionSettings = "External Tooltip Position Settings"
L.ConfigExtTipCustomAnchorEnable = "Enable Custom Anchor Position"
L.ConfigExtTipCustomAnchorLocation = "Custom Location"
L.ConfigExtTipCustomAnchorShow = "Show ExtTip Anchor"
L.ExtTipCustomAnchor_TopLeft = "Top Left"
L.ExtTipCustomAnchor_TopRight = "Top Right"
L.ExtTipCustomAnchor_BottomLeft = "Bottom Left"
L.ExtTipCustomAnchor_BottomRight = "Bottom Right"
L.ExtTipCustomAnchor_Center = "Center"
L.ExtTipCustomAnchor_CenterTop = "Center Top"
L.ExtTipCustomAnchor_CenterBottom = "Center Bottom"
L.ExtTipCustomAnchor_UseAnchor = "Use ExtTip Anchor"
L.ExtTipAnchorLabel = "BagSync ExtTip Anchor\n\n(Right-Click to Save Position)"
...
L.ExtTooltipAnchor_Bottom = "Bottom"
L.ExtTooltipAnchor_Left = "Left"
L.ExtTooltipAnchor_Right = "Right"
L.ExtTipNoticeTitle = "External Tooltip (ExtTip) Notice"
L.ExtTipNoticeText = "|cFFFFFFFFBlizzard's |cFFFF0000Secret Values|r|cFFFFFFFF can block ExtTip positioning. BagSync adds safeguards, but if no safe tooltip is found, counts fall back to the |cFFFF0000GameTooltip|r|cFFFFFFFF. See the FAQ on |cFFFF0000'Secret Values'|r|cFFFFFFFF for details.|r"
...
L.CachingItemData = "Caching item data... (%d remaining)"
...
|cffff7d0aSearch Filters|r (|cFF99CC33commands|r | |cFFFFD580example|r):
...
L.FAQ_Question_8 = "Secret Value Errors & Blizzard Addon Restrictions"
L.FAQ_Question_8_p1 = [[
Blizzard's new |cFFDF2B2B"secret values"|r system is designed so addons can |cFF99CC33display|r certain combat-related data but |cFFDF2B2Bcannot safely inspect or compute on it|r. In tainted code paths, arithmetic, comparisons, and even some indexing on these values throw immediate Lua errors. These values can also "infect" frames and tooltips through secret aspects/anchors, so the |cFF99CC33same tooltip|r can start returning secret coordinates later, even if the addon touching it didn't create the secret value in the first place. That means a stack trace pointing at BagSync does |cFFDF2B2Bnot|r prove BagSync introduced the secret value; it often just means BagSync was the next addon to touch the already-tainted object.

This is not a BagSync-only problem. Blizzard's own UI is throwing the same "attempt to perform arithmetic on a secret value" errors (e.g., MoneyFrame / GameTooltip) even without third-party addons. Other addons are actively shipping emergency fixes or guards for the |cFF99CC33same exact error class|r triggered by secret values in tooltips and money frames. |cFFDF2B2BIn short: this is a broad platform issue, not a unique BagSync bug|r.

I |cFFDF2B2Bhave tried|r to add as many safeguards and defensive checks to reduce the odds of BagSync tripping these errors, but Blizzard has made secret values |cFFDF2B2Bincredibly hard to trace and control|r in a mixed-addon environment by design. This system actively prevents addons from reliably inspecting the value or even confirming |cFF99CC33where|r it originated. That is exactly why these errors are difficult to reproduce and why they often only show up when the error fires.
]]
L.BagSyncInfoWindow = [[
