...
L.Search = "Pesquisar"
L.Debug = "Depurar"
L.AdvSearchBtn = "Procurar/ Atualizar"
L.Reset = "Reiniciar"
L.Refresh = "Atualizar"
L.Clear = "Limpar"
...
L.ClickViewProfession = "Clique para ver a profissão:"
...
L.ProfilesErrorRemove = "Erro ao excluir o BagSync."
L.ProfileBeenRemoved = "[%s] [|cFF99CC33%s|r] perfil excluído do BagSync!"
L.ProfessionsFailedRequest = "O pedido do servidor falhou."
...
L.ScanGuildBankStart = "Consultando o servidor para informações do Banco da Guilda, por favor espere...."
...
L.ScanGuildBankScanInfo = "Escaneando aba da guilda (%s/%s)."
...
L.DisplayMailbox = "Mostrar os itens da caixa de correio."
L.DisplayAuctionHouse = "Mostrar itens da casa de leilões."
...
L.DisplaySourceDebugInfo = "Mostra informação útil [Depurar] na dica."
...
L.DisplayGuildSeparately = "Mostrar os nomes e os totais de itens da [Guilda] separadamente dos totais dos personagens."
L.DisplayGuildCurrentCharacter = "Mostrar os itens da [Guilda] apenas para os personagens conectados atualmente."
L.DisplayGuildBankScanAlert = "Mostra a janela de alerta do Banco da Guilda."
...
L.ConfigHeader = "Configurações para vários recursos BagSync."
...
L.ConfigSearchHeader = "Configuração da janela de pesquisa"
L.ConfigFont = "Fonte"
...
L.WarningUpdatedDB = "Você foi atualizado para a versão mais recente do banco de dados! Você precisará reescane todos os seus personagens novamente! |r"
