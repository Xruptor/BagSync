...
-- ----------------------        
	...
	["/bgs fixdb - Runs the database fix (FixDB) on BagSync."] = "/bgs fixdb - BagSync에 데이터베이스 개선 (FixDB) 실행",
        ...
        ["Display [Total] in tooltips and gold display."] = "툴팁과 골드 표시 창에 [총] 항목 표시하기.",
        ...
        ["Enable items for Cross-Realms characters."] = "다른 서버 캐릭터의 아이템 사용.",
        ["Enable items for current Battle.Net Account characters |cFFDF2B2B(Not Recommended)|r."] = "현재 Battle.Net 계정 캐릭터의 아이템 사용 |cFFDF2B2B(권장하지 않음)|r.",
